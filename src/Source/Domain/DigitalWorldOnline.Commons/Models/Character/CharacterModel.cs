...
namespace DigitalWorldOnline.Commons.Models.Character
{
    ...
    public sealed partial class CharacterModel
    {
        ...
        public DateTime? LastDebuffRemovedTime { get; set; }
        ...
        public short LastOpenMapId { get; set; }
        public int LastOpenMapX { get; set; }
        public int LastOpenMapY { get; set; }
        ...
        /// Set client option.
        /// </summary>
        public int ClientOption { get; private set; } = 0; // Valor padrão
        ...
        public List<CharacterActiveDeckModel> ActiveDeck { get; set; }

        //public List<MacroProtectorModel> MacroProtectors { get; set; } = new List<MacroProtectorModel>();
        ...
        public DateTime LastCombatInteractionTime { get; set; } = DateTime.MinValue;
        ...
        public bool MagneticCracked { get; set; } = true;

        public bool MagneticAttribute { get; set; } = true;

        public bool MagneticGear { get; set; } = true;

        public bool MagneticDigiEggs { get; set; } = true;

        public bool MagneticSeal { get; set; } = true;
        ...
        public CharacterModel()
        {
            ...
            DailyPoints = new CharacterArenaDailyPointsModel(DateTime.Now, 0, Id);
            CurrentActiveDeck = 0;
            ActiveDeck = new List<CharacterActiveDeckModel>();
