namespace DigitalWorldOnline.Commons.Models.Digimon
{
    public sealed partial class DigimonBuffListModel
    {
        ...
        public bool ActiveSkillDamageIncrease()
        {
            return ActiveBuffs.Any(buff => buff.BuffInfo.SkillInfo.Apply.Any(apply =>
                    apply.Attribute == Enums.SkillCodeApplyAttributeEnum.SCD));
        }

        public bool SkillBuffActive()
        {
            return ActiveBuffs.Any(buff => buff.BuffInfo.SkillInfo.Apply.Any(apply =>
                    apply.Attribute == Enums.SkillCodeApplyAttributeEnum.Unbeatable));
        }

        public bool DottSkillDamage()
        {
            return ActiveBuffs.Any(buff => buff.BuffInfo.SkillInfo.Apply.Any(apply =>
                    apply.Attribute == Enums.SkillCodeApplyAttributeEnum.DOT2));
        }

        public bool ActiveAttackDamageIncrease()
        {
            return ActiveBuffs.Any(buff => buff.BuffInfo.SkillInfo.Apply.Any(apply =>
                    apply.Attribute == Enums.SkillCodeApplyAttributeEnum.EvolutionStepDamageIncreaseBuff));
        }
        ...
        public bool ActiveDebuffTakenDamage()
        {
            return ActiveBuffs.Any(buff => buff.BuffInfo.SkillInfo.Apply.Any(apply =>
                    apply.Attribute == Enums.SkillCodeApplyAttributeEnum.TotalDamageTaken));
        }
