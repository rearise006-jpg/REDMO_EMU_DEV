    ...
    public sealed partial class SummonMobModel : IMob
    {
        ...
        public void SetInitialLocation()
        {
            if (InitialLocation == null)
                InitialLocation = new Location(Location.MapId, Location.X, Location.Y);

            if (CurrentLocation == null)
                CurrentLocation = new Location(Location.MapId, Location.X, Location.Y);

            if (PreviousLocation == null)
                PreviousLocation = new Location(Location.MapId, Location.X, Location.Y);
        }
