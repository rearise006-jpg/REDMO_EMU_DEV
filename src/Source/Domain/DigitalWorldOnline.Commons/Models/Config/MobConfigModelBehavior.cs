...
namespace DigitalWorldOnline.Commons.Models.Config
{
    public sealed partial class MobConfigModel :  IMob
    {
        ...
        public static double CalcularProbabilidadeAcerto(double seuHitRate,
            int seuNivel, int nivelDoMonstro, double evDoMonstro, double attributeAdvantage)
        {
        ...
        public bool SpawnedFromCard { get; private set; } = false;

        public void SetSpawnedFromCard(bool value = true)
        {
            SpawnedFromCard = value;
        }
        ...
        public void SetCanSpawn(bool canSpawn = true) => CanSpawn = canSpawn;
        ...
        public void UpdateTarget(CharacterModel tamer)
        {
            if (!TargetTamers.Any(x => x.Id == tamer.Id))
                TargetTamers.Add(tamer);
        ...
        public void SetMobChannel(byte value)
        {
            MobChannel = value;
        }

        public void SetAgroTarget(int value)
        {
