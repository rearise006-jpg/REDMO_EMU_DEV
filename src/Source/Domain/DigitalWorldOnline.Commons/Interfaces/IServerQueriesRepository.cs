...
namespace DigitalWorldOnline.Commons.Interfaces
{
    public interface IServerQueriesRepository
    {
        ...
        Task<List<KillSpawnConfigDTO>> GetKillSpawnConfigAsync();
        ...
        Task<ArenaRankingDTO> GetLastArenaRankingAsync(ArenaRankingEnum arenaRankingEnum);
        Task<ArenaRankingDTO> GetArenaOldRankingAsync(ArenaRankingEnum arenaRankingEnum);
        ...
        Task<MastersMatchDTO> GetMasterMatchDataAsync();
        Task<MastersMatchRankerDTO> GetMasterMatchRankerDataAsync(long characterId);
    }
}
