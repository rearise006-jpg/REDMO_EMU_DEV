...
namespace DigitalWorldOnline.Commons.Interfaces
{
    public interface IServerCommandsRepository
    {
        ...
        Task UpdateDigimonDeckRewardAsync(DigimonModel digimon);

        Task<MastersMatchRankerDTO> CreateMasterMatchPlayerCommandAsync(long characterId, string tamerName, MastersMatchTeamEnum assignedTeam);
    }
}