...
namespace DigitalWorldOnline.Commons.Interfaces
{
    public interface ICharacterCommandsRepository
    {
        ...
        Task<List<DigimonEvolutionDTO>> UpdateDigimonEvolutionsAsync(long digimonId, List<DigimonEvolutionModel> evolutions);
        ...
        Task UpdateCharacterActiveDeckAsync(CharacterModel character);
        ...
        Task UpdateMasterMatchRankerAsync(long characterId, string tamerName, MastersMatchTeamEnum team, int donatedAmount);

        Task UpdateCharacterDigimonGrowthAsync(CharacterDigimonGrowthSystemModel characterDigimonGrowth);

        Task UpdateDigimonSkillMemoryAsync(DigimonSkillMemoryModel evolution);

        Task DeleteDigimonSkillMemoryAsync(long skillId, long evolutionId);

        Task DeleteCharacterDigimonGrowthAsync(int growthSlot);

        Task UpdateCharacterFortuneEventAsync(CharacterFortuneEventModel fortuneEvent);
        Task UpdateDigimonSkillCodeAsync(DigimonEvolutionSkillModel skills);
        Task<bool> UpdateCharacterLastOpenMapAsync(long characterId, short mapId, int x, int y);
    }
}
