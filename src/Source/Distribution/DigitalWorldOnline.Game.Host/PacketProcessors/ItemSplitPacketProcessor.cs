...
namespace DigitalWorldOnline.Game.PacketProcessors
{
    public class ItemSplitPacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            _logger.Debug($"Character {client.TamerId} split {itemListMovimentation} from slot {originSlot} to {destinationSlot} x{amountToSplit}.");
                ...
                case ItemListMovimentationEnum.InventoryToInventory:
                    {
                        ...
                        if (sourceItem == null || amountToSplit <= 0 || sourceItem.Amount < amountToSplit)
                        {
