    ...
    public class SealClosePacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            if (targetSeal != null)
            {
                ...
                var availableClosers = _assets.ItemInfo.Values.Where(x => x.Type == 192 && x.Section == 19201);
                ...
                sealItem.SetItemInfo(_assets.ItemInfo.GetValueOrDefault(sealItem.ItemId));
