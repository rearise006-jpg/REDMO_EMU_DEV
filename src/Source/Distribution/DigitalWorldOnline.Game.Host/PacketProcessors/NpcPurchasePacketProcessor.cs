...
namespace DigitalWorldOnline.Game.PacketProcessors
{
    public class NpcPurchasePacketProcessor : IGamePacketProcessor
    {
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            purchasingItem.SetItemInfo(_assets.ItemInfo.GetValueOrDefault(npcItem.ItemId));
            ...
            if (purchasingItem.ItemInfo!.EventPriceId > 0)
            {
                ...
                _logger.Information($"Trying to remove Amount Require={purchasingItem.ItemInfo.EventPriceId}, ItemId={eventItemPrice}. Player has: {client.Tamer.Inventory.CountItensById(purchasingItem.ItemInfo.EventPriceId)}");
