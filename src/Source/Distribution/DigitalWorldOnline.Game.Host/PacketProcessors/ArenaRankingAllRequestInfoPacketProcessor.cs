...
namespace DigitalWorldOnline.Game.PacketProcessors
{
    ...
    {
        public GameServerPacketEnum Type => GameServerPacketEnum.ArenaRequestRank;

        private readonly ILogger _logger;
        private readonly ISender _sender;
        private readonly IMapper _mapper;

        public ArenaRankingAllRequestInfoPacketProcessor(ILogger logger, ISender sender, IMapper mapper)
        {
            _logger = logger;
            _sender = sender;
            _mapper = mapper;
        ...
        public async Task Process(GameClient client, byte[] packetData)
        {
            ...
            if (rankingWeeklyInfo != null)
            {
                ...
                client.Send(new ArenaRankingInfoPacket((int)client.TamerId,rankingWeeklyInfo, ArenaRankingEnum.Weekly, ArenaRankingStatusEnum.Running, ArenaRankingPositionTypeEnum.Absolut));
            ...
            if(rankingMonthlyInfo != null)
            {
                ...
                client.Send(new ArenaRankingInfoPacket((int)client.TamerId, rankingMonthlyInfo, ArenaRankingEnum.Monthly, ArenaRankingStatusEnum.Running, ArenaRankingPositionTypeEnum.Absolut));
            ...
            if (rankingSeasonalInfo != null)
            {
                ...
                client.Send(new ArenaRankingInfoPacket((int)client.TamerId, rankingSeasonalInfo, ArenaRankingEnum.Seasonal, ArenaRankingStatusEnum.Running, ArenaRankingPositionTypeEnum.Absolut));
