...
using DigitalWorldOnline.Application_Game;
...
namespace DigitalWorldOnline.Game
{
    public class Program
    {
        ...
        public static IHost CreateHostBuilder(string[] args)
        {
            ...
            Console.Title = $"Edge of Infinity :: GameServer";
            ...
            var host =  Host.CreateDefaultBuilder(args)
                ...
                .ConfigureServices((context, services) =>
                {
                    ...
                    services.AddSingleton<TamerSkillManager>();
                    services.AddSingleton<EventQueueManager>();
                    services.AddSingleton<IMapServer, MapServer>();
                    ...
                    services.AddMediatR(typeof(GameApplicationHandlersMarker).Assembly);
