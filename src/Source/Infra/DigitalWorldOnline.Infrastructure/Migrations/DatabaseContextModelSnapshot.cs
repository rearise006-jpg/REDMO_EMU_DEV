...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Account.AccountDTO", b =>
            {
                ...
                b.Property<int>("DailyRewardClaimedAmount")
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Character.CharacterActiveDeckDTO", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");
                ...
                b.ToTable("ActiveDeck", "Character");
            });
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Character.CharacterDTO", b =>
            {
                ...
                b.Property<int?>("CurrentActiveDeck")
                    .HasColumnType("int");
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Character.CharacterDigimonGrowthSystemDTO", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");
                ...
                b.Property<int>("ExperienceAccumulated")
                    .HasColumnType("int");

                b.Property<int>("GrowthItemId")
                    .HasColumnType("int");

                b.Property<int>("GrowthSlot")
                    .HasColumnType("int");
                ...
                b.ToTable("DigimonGrowthSystem", "Character");
            });
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.GlobalDropsConfigDTO", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int");
                ...
                b.Property<byte>("MaxDrop")
                    .HasColumnType("tinyint");

                b.Property<byte>("MinDrop")
                    .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Config.HashDTO", b =>
            {
                ...
                b.HasData(
                    ...
                    {
                        Id = 1L,
                        CreatedAt = new DateTime(2025, 9, 28, 3, 45, 59, 843, DateTimeKind.Local).AddTicks(812),
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Digimon.DigimonDTO", b =>
            {
                ...
                b.Property<byte>("DeckRewardReceived")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("tinyint")
                    .HasDefaultValue((byte)0);
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Digimon.DigimonSkillMemoryDTO", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");
                ...
                b.Property<byte>("EvolutionStatus")
                    .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Mechanics.MastersMatchDTO", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");
                ...
                b.Property<int>("TeamADonations")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
                    .HasDefaultValue(0);

                b.Property<int>("TeamBDonations")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
                    .HasDefaultValue(0);
                ...
                b.ToTable("MastersMatch", "MastersMatch");
            });

            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Mechanics.MastersMatchRankerDTO", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");
                ...
                b.Property<long>("MastersMatchId")
                    .HasColumnType("bigint");

                b.Property<short>("Rank")
                    .HasColumnType("smallint");

                b.Property<string>("TamerName")
                    .IsRequired()
                    .HasMaxLength(24)
                    .HasColumnType("varchar");
                ...
                b.HasIndex("MastersMatchId");

                b.ToTable("MastersMatchRanker", "MastersMatch");
            });
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Routine.RoutineDTO", b =>
            {
                ...
                b.HasData(
                    new
                    {
                        Id = 1L,
                        Active = true,
                        CreatedAt = new DateTime(2025, 9, 28, 3, 45, 59, 855, DateTimeKind.Local).AddTicks(7312),
                        Interval = 1,
                        Name = "Daily Quests",
                        NextRunTime = new DateTime(2025, 9, 29, 0, 0, 0, 0, DateTimeKind.Local),
                        Type = 1
                    },
                    new
                    {
                        Id = 2L,
                        Active = true,
                        CreatedAt = new DateTime(2025, 9, 28, 3, 45, 59, 855, DateTimeKind.Local).AddTicks(7346),
                        Interval = 1,
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.Models.Assets.AchievementAssetDTO", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.Models.Assets.CashShopAssetDTO", b =>
            {
                b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("int")
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.Models.Assets.TimeRewardAssetDTO", b =>
            {
                b.Property<long>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("bigint");
            ...
            modelBuilder.Entity("DigitalWorldOnline.Commons.DTOs.Mechanics.MastersMatchRankerDTO", b =>
            {
                ...
                b.HasOne("DigitalWorldOnline.Commons.DTOs.Mechanics.MastersMatchDTO", "MastersMatch")
                    .WithMany("Rankers")
                    .HasForeignKey("MastersMatchId")
                    .OnDelete(DeleteBehavior.Cascade)
                    .IsRequired();

                b.Navigation("Character");

                b.Navigation("MastersMatch");
            });
