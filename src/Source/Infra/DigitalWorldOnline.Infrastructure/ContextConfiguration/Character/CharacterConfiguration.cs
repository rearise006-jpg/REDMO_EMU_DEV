...
namespace DigitalWorldOnline.Infrastructure.ContextConfiguration.Character
{
    public class CharacterConfiguration : IEntityTypeConfiguration<CharacterDTO>
    {
        public void Configure(EntityTypeBuilder<CharacterDTO> builder)
        {
            ...
            builder
                .Property(x => x.CurrentActiveDeck)
                .HasColumnType("int")
                .HasDefaultValue(0)
                .IsRequired(false);

            //builder
            //    .Property(x => x.CurrentActiveExpBonus)
            //    .HasColumnType("int")
            //    .HasDefaultValue(0)
            //    .IsRequired(false);

            //builder
            //    .Property(x => x.CurrentDailyExpBonusCount)
            //    .HasColumnType("int")
            //    .HasDefaultValue(0)
            //    .IsRequired(false);

            //builder
            //    .Property(x => x.NextDayExpBonus)
            //    .HasColumnType("int")
            //    .HasDefaultValue(0)
            //    .IsRequired(false);

            //builder
            //    .Property(x => x.CurrentFatigue)
            //    .HasColumnType("int")
            //    .HasDefaultValue(0)
            //    .IsRequired();
